function [dn_dlogd, d, ci_dn_dlogd] = avg_dist_2(d0, dn0_dlogd, opts)
...
% ci_dn_dlogd: 95% confidence interval for average size distribution
...
ci_dn_dlogd = tinv(0.95, length(d0)-1) * std(dn00_dlogd, 0, 1) /...
    sqrt(length(d0));
