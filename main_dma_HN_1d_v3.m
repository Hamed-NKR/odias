...
% tname0 = '21AUG24_HIGHAGGLOM_TANDEM'; % tandem measurements for high...
%     % ...agglomeration case on 21 Aug. 2024
% tname0 = '20AUG24_LOWAGGLOM_TANDEM'; % tandem measurements for low...
%     % ...agglomeration case on 20 Aug. 2024
% tname0 = '20AUG24_HIGHAGGLOM_TANDEM'; % tandem measurements for high...
%     % ...agglomeration case on 20 Aug. 2024
% tname0 = '28AUG24_HIGHAGGLOM_TANDEM'; % tandem measurements for high...
%     % ...agglomeration case on 20 Aug. 2024
% tname0 = '26JUL24_LOWAGGLOM_TANDEM'; % tandem measurements for low...
%     % ...agglomeration case on 26 Jul. 2024
% tname0 = '30JUL24_HIGHAGGLOM_TANDEM'; % tandem measurements for high...
%     % ...agglomeration case on 30 Jul. 2024
% tname0 = '06FEB25_R1_EXAGGLOM_TANDEM'; % tandem measurements for extreme...
%     % ...agglomeration case on 06 Feb. 2025
% tname0 = '06FEB25_R2_EXAGGLOM_TANDEM'; % tandem measurements for extreme...
%     % ...agglomeration case on 06 Feb. 2025
% tname0 = '07FEB25_EXCOLAPS_TANDEM'; % tandem measurements for extreme...
%     % ...collapse case on 07 Feb. 2025
% tname0 = '08FEB25_EXCOLAPS_TANDEM'; % tandem measurements for extreme...
%     % ...collapse case on 08 Feb. 2025
% tname0 = '11FEB25_LOAGLOM_TANDEM'; % tandem measurements for low...
%     % ...agglomeration case on 11 Feb. 2025
% tname0 = '12FEB25_R1_EXAGLOM_TANDEM'; % tandem measurements for extreme...
%     % ...agglomeration case on 12 Feb. 2025
% tname0 = '12FEB25_R2_EXAGLOM_TANDEM'; % tandem measurements for extreme...
%     % ...agglomeration case on 12 Feb. 2025
% tname0 = 'MOBIL_DIST_FEB25'; % mobility size distibutions for all...
%     % ...conditions during 06-12 Feb. 2025
tname0 = 'MAY25_TANDEM_COMPARE'; % tandem size distibutions for selected...
    % ...setpoints at all conditions for assessing inversion
